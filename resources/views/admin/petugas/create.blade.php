...
<div class="pb-28 bg-gray-50/50 min-h-screen">
    ...
    <div class="bg-white px-5 pt-6 pb-6 shadow-[0_4px_20px_rgb(0,0,0,0.02)] rounded-b-3xl border-b border-gray-100 mb-6 sticky top-0 z-20">
        <h1 class="text-xl font-black text-gray-900 tracking-tight leading-tight">Registrasi Pengguna</h1>
        <p class="text-xs text-gray-500 font-medium mt-1">Tambahkan akun admin atau petugas baru ke dalam sistem.</p>
    </div>
    ...
    <div class="px-5">
        <form method="POST" action="{{ route('admin.petugas.store') }}" class="space-y-6">
            ...
            ─────────────────────────────────────────────── --}}
            @if($errors->any())
                <div class="bg-red-50 border border-red-200 rounded-2xl p-4 flex gap-3 shadow-sm">
            ...
            <div class="bg-white rounded-3xl p-6 shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-gray-100 space-y-5 relative overflow-hidden">
                <div class="absolute right-0 top-0 w-32 h-32 bg-blue-50/50 rounded-bl-full -z-10"></div>
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="text" name="nama_petugas" value="{{ old('nama_petugas') }}" placeholder="Contoh: Budi Santoso"
                ...
                {{-- Telepon & Username (Grid on larger mobile screens) --}}
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="tel" name="telp" value="{{ old('telp') }}" placeholder="08xx..."
                ...
                {{-- Level / Role (Custom Dynamic Radio) --}}
                <div class="pt-2">
                    ...
                    <div class="grid grid-cols-2 gap-3">
                        ...
                        <label class="relative cursor-pointer group">
                            <input type="radio" name="level" value="petugas" class="peer sr-only" {{ old('level', 'petugas') === 'petugas' ? 'checked' : '' }} />
                            <div class="p-4 border-2 border-gray-100 rounded-2xl bg-gray-50 peer-checked:border-blue-500 peer-checked:bg-blue-50 hover:bg-gray-100 transition-all">
                                ...
                                <p class="text-[10px] font-semibold text-gray-400 peer-checked:text-blue-500/80">Kelola dan tanggapi laporan masuk.</p>
                            </div>
                        </label>

                        {{-- Opsi Admin --}}
                        <label class="relative cursor-pointer group">
                            <input type="radio" name="level" value="admin" class="peer sr-only" {{ old('level') === 'admin' ? 'checked' : '' }} />
                            <div class="p-4 border-2 border-gray-100 rounded-2xl bg-gray-50 peer-checked:border-amber-500 peer-checked:bg-amber-50 hover:bg-gray-100 transition-all">
                                ...
                                <p class="text-[10px] font-semibold text-gray-400 peer-checked:text-amber-600/80">Akses penuh ke semua fitur & rekap.</p>
                            </div>
                        </label>
                    </div>
                </div>
